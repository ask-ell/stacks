...
export interface IK8SCluster {
  ...
  getServiceAccountsFromNamespace(
    namespace: string
  ...
  createCustomResourceDefinition(
    dto: K8SCustomResourceDefinition
  ): Promise<void>;
  getAllClusterCustomObjectsFromResourceDefinition<
    CustomResource extends K8SCustomResource
  >(
    dto: K8SCustomResourceDefinition
  ): Promise<CustomResource[]>;
  createClusterCustomObject<CustomResource extends K8SCustomResource>(
    dto: PersistClusterCustomObjectDTO<CustomResource>
  ): Promise<void>;
  patchClusterCustomObject<CustomResource extends K8SCustomResource>(
    dto: PersistClusterCustomObjectDTO<CustomResource>
  ): Promise<void>;
  deleteClusterCustomObject<CustomResource extends K8SCustomResource>(
    dto: DeleteClusterCustomObjectDTO<CustomResource>
  ): Promise<void>;
}
